...
fun SignUpScreen(
    ...
    var bloodGroupIndex by remember { mutableStateOf(0) }
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            leadingIcon = {
                Icon(
                    ...
                    contentDescription = "User Phone Number"
                )
            }
        )
            ...
            Column(
                ...
                Row(
                    ...
                    Image(
                        ...
                        contentDescription = "Blood group drop down!"
                    )
                ...
                Text(
                    modifier = Modifier
                        .fillMaxWidth(0.85f),
                    text = bloodGroups[bloodGroupIndex],
                    fontSize = 15.sp,
                    fontFamily = poppinsFamily
                )
                DropdownMenu(
        ...
        Button(
            ...
            onClick = {
                if (email.isNotEmpty() && name.isNotEmpty() && phoneNumber.isNotEmpty() && password.isNotEmpty()){
